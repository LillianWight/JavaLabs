...
public class SimpleMenu {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.print("Type a c to continue: ");	// the program does not need the user to enter c to continue; it will run anyway. This line is irrelevant and should be removed.
        }
        scanner.close();
    }
}
